...
- Connect and Reconnect functions should check whether the device is currently connected or not
- Demonstrate write methods
- Demonstrate remaining helper functions for byte and string conversions
- Update documentation, including pretty print
*/
